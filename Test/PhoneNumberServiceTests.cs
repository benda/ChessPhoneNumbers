...
namespace Test
{
    ...
    public class PhoneNumberServiceTests
    {
        ...
        public void FindAllPhoneNumbers()
        {
            ...
            Assert.AreEqual(0,pns.FindAllPhoneNumbers(Pieces.Pawn.Piece).AllPaths.Count);
            Assert.AreEqual(952, pns.FindAllPhoneNumbers(Pieces.Bishop.Piece).AllPaths.Count);
            Assert.AreEqual(2341, pns.FindAllPhoneNumbers(Pieces.Knight.Piece).AllPaths.Count);
